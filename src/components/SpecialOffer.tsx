  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-lime-50/80 to-green-50/80"></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          ...
          <div ref={leftContentRef} className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl animate-on-scroll">
            ...
            <div className="text-center mb-8">
              <div className="relative w-32 h-32 mx-auto mb-4">
                <img 
                  ...
                  className="w-32 h-32 rounded-full object-cover shadow-xl border-4 border-lime-400"
                />
                <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-lime-400 rounded-full flex items-center justify-center border-3 border-white shadow-lg">
                  <span className="text-white text-sm font-bold">✓</span>
                </div>
              </div>
              <h3 className="text-3xl font-bold text-graphite mb-2 font-montserrat">Ася</h3>
              <p className="text-lime-600 font-semibold text-lg font-manrope">Сертифицированный фитнес-тренер</p>
            </div>

            {/* About Text */}
            <div className="text-center mb-8">
              <p className="text-graphite leading-relaxed font-manrope mb-4">
                <strong>Ася</strong> — сертифицированный фитнес-тренер, в процессе активного обучения на нутрициолога.
              </p>
              <p className="text-graphite leading-relaxed font-manrope mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {achievements.map((achievement, index) => (
                ...
                >
                  <div className={`w-10 h-10 bg-gradient-to-br ${achievement.color} rounded-xl flex items-center justify-center shadow-lg`}>
          ...
          <div className="space-y-8">
            ...
            <div ref={rightContentRef} className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl animate-on-scroll">
              <h3 className="text-2xl font-bold text-graphite mb-6 font-montserrat flex items-center gap-3">
                <Euro className="w-6 h-6 text-lime-500" />
                Цена и условия
              </h3>
              ...
              <div className="text-center bg-gradient-to-r from-lime-100 to-green-100 rounded-2xl p-6 mb-6">
                ...
                <p className="text-sage font-manrope">Цена запуска первые дни</p>
              </div>
            </div>
        ...
        <div ref={sloganRef} className="text-center mt-16 animate-on-scroll">
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute inset-0 bg-gradient-to-r from-lime-400 to-green-400 rounded-3xl blur-2xl opacity-20 animate-pulse"></div>
