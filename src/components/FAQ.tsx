...
const FAQ = () => {
  const faqItems = [
    {
      question: "Ответы на ваши вопросы",
      answer: "Здесь собраны самые частые вопросы от наших клиентов. Если не найдете ответ на свой вопрос, обязательно напишите нам!",
