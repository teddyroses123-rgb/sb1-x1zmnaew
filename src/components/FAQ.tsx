...
const FAQ = () => {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "В каждом рецепте — удобные теги и простые замены, чтобы вы могли адаптировать блюда под свои вкусы, ритм жизни и доступные ингредиенты. Всё устроено так, чтобы готовка не превращалась в квест, а приносила удовольствие и уверенность. Если поделитесь своим профилем или предпочтениями — я с радостью подберу подборку, которая будет работать именно для вас: по времени, по настроению, по стилю.",
